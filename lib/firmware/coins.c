...
false, 0,                          /* has_address_type_p2wpkh, address_type_p2wpkh (unused)*/ \
false, 0,                          /* has_address_type_p2wsh, address_type_p2wsh (unused)*/ \
...
//   coin_name             coin_shortcut  address_type  maxfee_kb          p2sh        p2wpkh     p2wsh      signed_message_header                           bip44_account_path  forkid/chain_id decimals    contract_address  gas_limit         xpub_magic       xprv_magic       segwit        force_bip143  curve_name               cashaddr_prefix       bech32_prefix  decred         version_group_id  xpub_magic_segwit_p2sh  xpub_mmagic_segwit_native
    ...
    {true, "Axe",          true, "AXE",   true,  55,    true,     100000,  true,  16,  false, 0,  false, 0,  true, "\x19" "DarkCoin Signed Message:\n",      true, 0x80001092,   false,   0,     true,   8,  false, {0, {0}},  false, {0, {0}},  true, 50221772,  true, 50221816,  true, false,  true, false,  true, SECP256K1_STRING,  false, "",            false, "",     false, false,  false, 0,         false,        0,        false,       0 },
    {true, "Bitcore",      true, "BTX",   true,   3,    true,     100000,  true,  125, false, 0,  false, 0,  true, "\x18" "BitCore Signed Message:\n",       true, 0x800000a0,   false,   0,     true,   8,  false, {0, {0}},  false, {0, {0}},  true, 76067358,  true, 76066276,  true, true,   true, false,  true, SECP256K1_STRING,  false, "",            true, "btx",   false, false,  false, 0,         true,  77429938,        true, 78792518 },
    {true, "Denarius",     true, "DNR",   true,  30,    true,     100000,  true,   90, false, 0,  false, 0,  true, "\x19" "Denarius Signed Message:\n",      true, 0x80000074,   false,   0,     true,   8,  false, {0, {0}},  false, {0, {0}},  true, 76067358,  true, 76066276,  true, false,  true, false,  true, SECP256K1_STRING,  false, "",            false, "",     false, false,  false, 0,         false,        0,        false,       0 },
